                                ...
                                <div class="col-xs-8 fn-s-16">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                                 <a href="{{route('client-portal.questions.create')}}" class="add {{$question->id ? 'd-none': ''}}">
            ...
            if(input.length > 2){
                ...
                if(input.questions[0] !== ""){
                    for(var i=0; i<input.questions.length;i++){
                        if(i==0){
                            $questionsWrapper.find(">div:last").find('select').val(input.questions[i]);
                        }else{
                            ...
                            $questionBlueprint.find('select').val(input.questions[i]);
