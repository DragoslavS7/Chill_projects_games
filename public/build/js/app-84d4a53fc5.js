...
ConfirmDialog.prototype._init = function () {
    // Dodaj html za dialog u body
    // snimi selektor ka dialogu na this
...
ConfirmDialog.prototype.show = function (gCB, bCB) {
    ...
    return function (event) {
        ...
        classContext._$dialog.find("#cancel").off().click(function () {
            ...
            isConfirmed = false;
            if (bCB) {
                bCB.call(eventContext, event);
            }
        });

        classContext._$dialog.off('hidden.bs.modal').on('hidden.bs.modal', function (e) {
            if (isConfirmed === undefined && bCB) {
                bCB.call(eventContext, event);
            }
        });
    };
...
},{"./ConfirmDialog":5,"./DataTablesMyArcadeChef":6,"bootstrap-sass/assets/javascripts/bootstrap":1,"datatables.net":2,"jquery":3,"moment":4}]},{},[7]);
