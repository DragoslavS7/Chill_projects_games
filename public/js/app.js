...
ConfirmDialog.prototype._init = function () {
    ...
    this._$dialog = $confirmationDialog.append('<div class="modal-dialog" role="document">' + '<div class="modal-content">' + '<div class="modal-header">' + '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>' + '<h4 class="modal-title">' + this.options.modal_title + '</h4>' + '</div>' + '<div class="modal-body text-center">' + '<p>' + this.options.modal_dialog_message + '</p>' + '</div>' + '<div class="modal-footer">' + '<button id="confirm" type="button" class="btn btn-primary">Confirm changes</button>' + '<button id="cancel" type="button" class="btn btn-default">Cancel</button>' + '</div>' + '</div><!-- /.modal-content -->' + '</div><!-- /.modal-dialog -->');
...
Tags.prototype.generateGuiForTag = function (tag) {
    this.options.$addedTagsContainer.append("<button data-tag='" + tag + "' type='button' class='btn btn-light bg-transparent mr-5 mt-5'>" + "<i class='fa fa-check w-20' aria-hidden='true'></i>" + tag + "</button>");
};
...
Tags.prototype.generateGuiForSuggestedTag = function (tag) {
    this.options.$suggestedTagsContainer.append("<button type='button' data-tag='" + tag + "' class='btn btn-light bg-transparent mr-5 mt-5'>" + "<i class='fa fa-plus w-20' aria-hidden='true'></i>" + tag + "</button>");
};
...
},{"./ConfirmDialog":5,"./DataTablesMyArcadeChef":6,"./Tags":7,"bootstrap-sass/assets/javascripts/bootstrap":1,"datatables.net":2,"jquery":3,"moment":4}]},{},[8]);
